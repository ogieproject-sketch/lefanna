    ...
    <section className="reviews">
      <div className="container">
        <div className="reviews-header" data-reveal="">
          ...
          <h2 className="reviews-title">{r.title} <em>{r.titleEm}</em></h2>
        </div>
      </div>
          ...
          {doubled.map((rev, i) => (
            <div key={i} className="review-card">
              <div className="review-card-img">
                ...
                <img src={rev.img} alt={rev.villa} />
              </div>
              <div className="review-card-body">
                <div className="review-stars">{[...Array(5)].map((_, s) => <span key={s}>★</span>)}</div>
                <div className="review-villa">{rev.villa}</div>
